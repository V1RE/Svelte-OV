...
<div class="card col-12 mb-3" class:open on:click={e=> { open = !open}}>
  <div class="card-body">
    <h5 class="card-title">{journey.journeys[0].sections[0].from.address.administrative_regions[0].name} <Mdicon path={mdiChevronRight} /> {journey.journeys[0].sections[journey.journeys[0].sections.length - 1].to.address.administrative_regions[0].name}</h5>
